...
//    }
    ...
    private void initRecycler() {
        ...
        wardrobeRecycler.setLayoutManager(new GridLayoutManager(WardrobeActivity.this, 2));//设置布局管理器
//        wardrobeRecycler.addItemDecoration(new DividerItemDecoration(this, GridLayoutManager.VERTICAL));
        // 设置item动画
